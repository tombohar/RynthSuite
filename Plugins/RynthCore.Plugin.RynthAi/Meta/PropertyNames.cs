...
/// <summary>
/// AC property-id → name, generated from ACE's PropertyInt/PropertyBool/
/// PropertyString enums. SPARSE on purpose: the real AC enums have gaps, so the
/// old dense position-indexed string[] mislabelled every property after the
/// first gap (the bug the SalvageManager STypes constants worked around).
/// Used by the dumpprops diagnostic. Returns null for unknown ids.
/// </summary>
internal static class PropertyNames
{
    private static readonly Dictionary<uint, string> IntNames = new()
    {
        { 0, "Undef" },
        { 1, "ItemType" },
        { 2, "CreatureType" },
        ...
        { 9001, "TotalLogins" },
        { 9002, "DeletionTimestamp" },
        { 9003, "CharacterOptions1" },
        { 9004, "CharacterOptions2" },
        { 9005, "LootTier" },
        { 9006, "GeneratorProbability" },
    ...
    private static readonly Dictionary<uint, string> BoolNames = new()
    {
        { 0, "Undef" },
        { 1, "Stuck" },
        { 2, "Open" },
    ...
    private static readonly Dictionary<uint, string> StringNames = new()
    {
        { 0, "Undef" },
        { 1, "Name" },
        { 2, "Title" },
    ...
    public static string? GetIntName(uint id)    => IntNames.TryGetValue(id, out var n) ? n : null;
    public static string? GetBoolName(uint id)   => BoolNames.TryGetValue(id, out var n) ? n : null;
    public static string? GetStringName(uint id) => StringNames.TryGetValue(id, out var n) ? n : null;
}
